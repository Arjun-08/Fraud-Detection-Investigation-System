...
def build_model(scale_pos_weight: float) -> LGBMClassifier:
    ...
    `scale_pos_weight` changes the training emphasis on the minority class.
    """
...
def save_model(model, feature_columns):
    ...
    print(f"[MODEL] Saved feature schema: {FEATURE_COLUMNS_PATH}")
